...
func TestFunctions(t *testing.T) {
	tests := []struct {
		...
		{"var a = func(x int) int { return x }; a(5)", 5},
		{"var a = func(x int) int { return x * 2 }; a(5)", 10},
		{"var a = func(x, y int) int { return x + y }; a(5, 5)", 10},
		{"var a = func(x, y int) int { return x + y }; a(5 + 5, a(5, 5))", 20},
		{"func(x int) int { return x }(5)", 5},
	}
